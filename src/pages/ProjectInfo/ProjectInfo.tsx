      ...
      <div>
        <Card title="工程概况" style={{ padding: '0 80px', fontSize: 16 }}>
          ...
          <section>
            ...
            <div><img src={img1} style={{ width: '100%', margin: '5px 0 15px' }} alt="选址示意图" /></div>
          ...
          <section>
            ...
            <div><img src={img2} style={{ width: '100%', margin: '15px 0 15px' }} alt="周边环境" /></div>
            <div style={{ textAlign: 'center' }}><span>图2 选址1周边环境</span></div>
            <div><img src={img3} style={{ width: '100%', margin: '25px 0 15px' }} alt="沉降装置选址" /></div>
          ...
          <section>
            ...
            <div><img src={img4} style={{ width: '100%', margin: '15px 0 15px' }} alt="正视图" /></div>
            <div style={{ textAlign: 'center' }}><span>正视图</span></div>
            <div><img src={img5} style={{ width: '100%', margin: '25px 0 15px' }} alt="侧视剖切图" /></div>
            <div style={{ textAlign: 'center' }}><span>侧视剖切图</span></div>
            <div><img src={img6} style={{ width: '100%', margin: '25px 0 15px' }} alt="沉降安装槽尺寸图" /></div>
